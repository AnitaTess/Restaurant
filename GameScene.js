const gameState = {
  ...
  // Move the next waiting customer forward
    ...
    //Method to updateStars, customer colour, 
    ...
    updateStars(fullnessValue, fullnessCapacity){
      ...
      if (fullnessValue > fullnessCapacity){
        ...
        gameState.currentCustomer.list[0].setTint(0xD89B3A);
    ...
    destroyWave(){
      ...
      gameState.waveCountText.setText(`${gameState.currentWaveCount}/3`)
